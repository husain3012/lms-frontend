      ...
      <div className={classes.main}>
        ...
        <Form onSubmit={postNoteHandler} className={classes.postFormContainer}>
          <div className={classes.leftInfoPane}>
            <StyledDivSecondary color={classroom.color} className={classes.classCodeBox}>
              <h2 className={classes.classCodeTitle}>Class Code</h2>
              <QRCode value={classroom.short_id} size={100} fgColor={getDarkerColor(classroom.color)} />
          ...
          <div className={classes.rightInfoPane}>
            ...
            <StyledButton variant="primary" className={classes.postButton} type="submit" color={classroom.color}>
              Post
            </StyledButton>
          </div>
        </Form>
